...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        if(lemonadeState==SELECT) {
            ...
            squeezeCount = b
            setViewElements()
            val mediaPlayer : MediaPlayer =  MediaPlayer.create(this,R.raw.foley_pick_apple_from_tree)
            mediaPlayer.start()
        }
            ...
            lemonadeState = DRINK
            setViewElements()
            val mediaPlayer : MediaPlayer =  MediaPlayer.create(this,R.raw.food_drink_milk_poured_into_glass)
            mediaPlayer.start()
        }
            ...
            setViewElements()
            val mediaPlayer : MediaPlayer =  MediaPlayer.create(this,R.raw.mix)
            mediaPlayer.start()
        }
        else if(lemonadeState==RESTART)
        {
            ...
            setViewElements()
            val mediaPlayer : MediaPlayer =  MediaPlayer.create(this,R.raw.unlockgame)
            mediaPlayer.start()
        }
    ...
    private fun setViewElements() {
        ...
        {
            textAction.setText("Click to juice it!")
        }
        else if(lemonadeState == DRINK)
        {
            textAction.setText("Click to drink the lemonade!")
        ...
        /*val toast1 = Toast.makeText(this,"1",Toast.LENGTH_SHORT)
        toast1.show()*/
    ...
    private fun showSnackbar(): Boolean {
        ...
        val mediaPlayer : MediaPlayer =  MediaPlayer.create(this,R.raw.ih)
        mediaPlayer.start()
        return true
    }
}
